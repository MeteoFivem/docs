...
metaLinks:
  alternates:
    - servers/meteo-fivem-server/documentation/getting-started.md
---
...
{% content-ref url="how-to/how-to-access-showcase-server.md" %}
[How to Access the Showcase Server](how-to/how-to-access-showcase-server.md)
{% endcontent-ref %}
