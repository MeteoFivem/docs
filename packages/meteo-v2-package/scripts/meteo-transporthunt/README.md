...
metaLinks:
  alternates:
    - servers/meteo-fivem-server/documentation/scripts/meteo-transporthunt/
---
...
{% hint style="warning" %}
Use `/setorglevel xp 5000` to get org to level 3. This command only works on our showcase server. Check [meteo-organizations test-commands](../meteo-organizations/test-commands.md) for more info
{% endhint %}
