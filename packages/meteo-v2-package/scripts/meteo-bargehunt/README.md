...
metaLinks:
  alternates:
    - servers/meteo-fivem-server/documentation/scripts/meteo-bargehunt/
---
...
{% hint style="warning" %}
Use `/setorglevel xp 2000` to get org to level 2. This command only works on our showcase server. For more info check [meteo-organizations test-commands](../meteo-organizations/test-commands.md)
{% endhint %}
