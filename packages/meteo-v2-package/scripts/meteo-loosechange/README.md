...
metaLinks:
  alternates:
    - servers/meteo-fivem-server/documentation/scripts/meteo-loosechange/
---
...
* **from registers** - meteo\_foldedcash ($100-500), reward boxes, diamond\_ring, rolex
* **from shelves** - reward boxes, meteo\_foldedcash ($50-200), iphone, water\_bottle
* **from shopkeeper** - diamond\_ring, goldbar, rolex, diamond, reward boxes, meteo\_datafile
