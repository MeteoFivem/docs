...
metaLinks:
  alternates:
    - servers/meteo-fivem-server/documentation/changelogs.md
---
...
* Major permissions system update. You can now create groups and configure permissions. Refer to the [docs](https://docs.meteofivem.net/packages/meteo-v2-package/how-to/how-to-script-permissions)
