...
Meteo Apartments comes pre-configured with the WiWang Hotel MLO (380 rooms) by [FL0KY](https://forum.cfx.re/t/mlo-wiwang-hotel-380-rooms/5364084). (Note: we only pre configured for 20 rooms. you can create more rooms using our built in apartments creator easily)
...
Now that installation is complete, you need to configure the apartment system for your server.

**You can:**

* Set up starter apartments for new players
* Create new apartment complexes
* Add custom rooms to existing complexes
* Configure doorlock security levels
* Set up member permissions and roles

We'll add detailed guides for these topics soon.
