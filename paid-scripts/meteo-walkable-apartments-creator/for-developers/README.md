...
[**QBX Garages Setup Guide**](../configuration-guide/qbx-garages-integration.md)

#### QBX Starter Apartments

Use Meteo Apartments as your starter apartment system. Replaces qbx\_properties spawn selection.

[**QBX Starter Apartments Setup Guide**](../configuration-guide/qbx-starter-apartments.md)
