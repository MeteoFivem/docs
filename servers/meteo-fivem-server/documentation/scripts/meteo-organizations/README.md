...
This is a guide about testing the meteo fivem crime organizations script designed exclusively for meteo server.
...
* First pay weekly upkeep
* Add members as you want and check them too
...
{% hint style="success" %}
All organization settings, treasury, upkeep costs, territory limits, level requirements and HQ settings are configurable on our config. You can change them once you get the server. We will guide you :)
{% endhint %}
