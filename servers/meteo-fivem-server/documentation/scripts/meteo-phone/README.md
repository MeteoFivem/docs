...
* **Phone** - make calls, video calls with WebRTC support
* **SMS** - send messages, group chats
* **Contacts** - manage your contacts
* **Camera** - take photos for gallery
* **App Store** - install more apps
* **Settings** - wallpapers (8 options), ringtones (10 options), volume, zoom

### Apps from App Store

* **Bleeter** - social media app (costs $500 to create account, max 3 accounts)
* **Laber** - job system (taxi, repo, bus, delivery, cleaning, electrician, gruppe6)
* **Yellow Pages** - marketplace ads with location based businesses
* **Security** - place cameras and motion sensors, detect with digiscanner
* **Music** - music app with artist support and custom accounts
