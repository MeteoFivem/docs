...
This is a guide about testing the meteo fivem dumpster search script designed exclusively for meteo server.
...
* **uncommon items** - iphone, lockpick, oxy
...
* all loot tables, search duration, cooldown time and fingerprint chances are configurable on our config. you can change them once you get the server. we will guide you :)
* connected with [meteo-perks](../meteo-perks/). if you have **Light Hands** specialization - Sharp Eyes makes you search dumpsters faster, Dumpster Pro reduces cooldown, Jackpot gives bonus loot chance, Gold Digger increases cash from scavenging
* connected with [meteo-evidence](../meteo-evidence/) for fingerprint drops
